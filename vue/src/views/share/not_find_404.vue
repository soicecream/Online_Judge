<template>
  <div class="stars">
    <div class="central-body" >
      <!--404-->
      <img src="../../assets/img/svg/404/404.svg" style="width: 300px;">
      <!--返回-->
      <div class="btn-go">
    ...
    <div>
      <!-- 火箭 -->
      <img class="rocket" src="../../assets/img/svg/404/rocket.svg" width="40px">

      <div class="earth-moon">
        <!--地球-->
        <img class="earth" src="../../assets/img/svg/404/earth.svg" width="100px">
        <!-- 月亮 -->
        <img class="moon" src="../../assets/img/svg/404/moon.svg" width="80px">
      </div>

      <div class="astronaut_box">
        <!--宇航员-->
        <img class="astronaut" src="../../assets/img/svg/404/astronaut.svg" width="140px">
      </div>
    </div>
...
/*小星星*/
.stars {
  background: url('../../assets/img/svg/404/overlay_stars.svg') repeat left top;
}
